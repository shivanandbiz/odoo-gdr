...
def migrate_apr_june_payments():
    fname = '/home/biz/odoo/apr_june_payment.xlsx'
    ...
    # Now use SQL for the actual deletions
    env.cr.execute("DELETE FROM account_payment WHERE memo LIKE 'PAY_APR_JUNE/%%' OR memo LIKE 'AJ_%%'")
    env.cr.execute("DELETE FROM account_move WHERE ref LIKE 'PAY_APR_JUNE/%%' OR ref LIKE 'AJ_%%'")
