...
class ProfitLossReport extends Component {
    static template = "gdr_profit_loss.ProfitLossReport";
    ...
    setup() {
        ...
        this.state = useState({
            lines: [],
            dateFrom: startOfYear.toFormat("yyyy-MM-dd"),
            dateTo: today.toFormat("yyyy-MM-dd"),
            dateFromDisplay: startOfYear.toFormat("MM/dd/yyyy"),
    ...
    async loadData() {
        ...
        try {
            ...
            this.state.dateFromDisplay = data.date_from;
            this.state.dateToDisplay = data.date_to;
            this.state.hasUnposted = data.has_unposted;
        } catch (e) {
            console.error("Error loading profit and loss data:", e);
        }
    ...
    async onXlsxClick() {
        ...
        a.href = url;
        a.download = `Profit_and_Loss_${this.state.dateTo}.csv`;
        a.click();
...
registry.category("actions").add("gdr_profit_loss_report", ProfitLossReport);
